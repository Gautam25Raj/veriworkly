...
Portfolios are published from a single PORTFOLIO-type [Document](/api-reference/documents/overview) to a
...
For uploading portfolio images, see [Portfolio Assets](/api-reference/portfolio-assets/overview).
