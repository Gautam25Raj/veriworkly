...
the general auth secret. The stored record keeps a short display prefix and suffix so you can
recognise a key in the list without being able to reconstruct it.
...
| `ai:write`       | Call the AI generation endpoint, spending the account's AI credits.    |
