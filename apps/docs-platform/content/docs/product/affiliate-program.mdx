...
<Callout type="warn" title="Tier promotion is manual, not automatic">
  ...
  thing that actually changes an affiliate's tier is a human admin action in the monetization
  console at `/admin/monetization`.
</Callout>
...
See the [Affiliates API reference](/api-reference/affiliates) for the full endpoint list, including
