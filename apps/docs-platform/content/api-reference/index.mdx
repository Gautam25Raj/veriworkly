...
per 15 minutes. See [API Keys](/api-reference/api-keys) for scopes and lifecycle.
...
| Scope                                | Limit                    |
| :----------------------------------- | :----------------------- |
| Default (per IP)                     | 100 requests / 15 min    |
...
<Card title="API Keys" icon={<Shield />} href="/api-reference/api-keys">
